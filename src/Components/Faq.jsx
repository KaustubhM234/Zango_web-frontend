...
const FAQ = () => {
  const faqData = [
    { question: 'How can i place order?', answer: 'Open the app -> browse restaurants -> select your desired items -> add items ->add items to your cart ->proceed to checkout ->choose payment method and delivery address -> confirm your order ' },
    ...
    { question: 'How long does it take to delivery', answer: 'Delivery time may vary depending on your location and restaurant.On average,deliveries are typically made within 30-45 minutes .You can track your order in real time through the app' },
    { question: 'Can I cancel my Order', answer: 'Yes,you can cancel your order before it is prepared by the restaurant,Once the restaurant starts preparing your order,cancellation may not be possible' },
